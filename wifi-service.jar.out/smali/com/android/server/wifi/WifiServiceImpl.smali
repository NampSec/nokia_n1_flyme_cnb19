...
.field mWifiCsmClient:Lcom/android/server/wifi/WifiCsmClient;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 330
    :try_start_0
    new-instance v2, Lcom/android/server/wifi/WifiCsmClient;

    iget-object v3, p0, Lcom/android/server/wifi/WifiServiceImpl;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3, p0}, Lcom/android/server/wifi/WifiCsmClient;-><init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;)V

    iput-object v2, p0, Lcom/android/server/wifi/WifiServiceImpl;->mWifiCsmClient:Lcom/android/server/wifi/WifiCsmClient;
    :try_end_0
    ...
    const-string v3, "Unable to create WifiCsmClient."
    ...
    .line 343
    .restart local v0    # "e":Lcom/intel/cws/cwsservicemanager/CsmException;
    const-string v2, "WifiService"
...
.method public checkAndStartWifi()V
    ...
    const-string v4, "intel.intent.action.ACTION_COEX_SAFECHANNELS_INFO_WF"
...
.method public configureWlanRTCoex()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiStateMachine;->configureWlanRTCoex()V
...
.method public getWifiSafeChannelBitmap()I
    ...
    .prologue
    .line 349
    iget-object v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->mWifiCsmClient:Lcom/android/server/wifi/WifiCsmClient;
    ...
    const-string v1, "getWifiSafeChannelBitmap: mWifiCsmClient is null"
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiCsmClient;->getWifiSafeChannelBitmap()I
...
.method public setRTCoexMode(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wifi/WifiStateMachine;->setRTCoexMode(II)V
...
.method public setSafeChannel(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wifi/WifiStateMachine;->setSafeChannel(I)V
...
.method public updateIccNetworks(Z)Z
    .locals 2
    .param p1, "enable"    # Z
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/server/wifi/WifiStateMachine;->syncUpdateIccNetworks(Lcom/android/internal/util/AsyncChannel;Z)Z
