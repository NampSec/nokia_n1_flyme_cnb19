...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/content/pm/PackageParser$LRTComparator;,
...
.method private static collectCertificates(Landroid/content/pm/PackageParser$Package;Ljava/io/File;I)V
    ...
    .line 1151
    invoke-static/range {p0 .. p0}, Landroid/content/pm/LicPermVerifier;->verifyCertPackage(Landroid/content/pm/PackageParser$Package;)Z
    ...
    const-string v15, "Invalid certification in licensed permissions in the package "
    ...
    const-string v16, "Invalid certification in licensed permissions in the package "
...
.method private parseBaseApk(Ljava/io/File;Landroid/content/res/AssetManager;I)Landroid/content/pm/PackageParser$Package;
    ...
    .line 903
    new-instance v26, Landroid/content/pm/LicPermissionParser;

    invoke-direct/range {v26 .. v26}, Landroid/content/pm/LicPermissionParser;-><init>()V

    .line 904
    .local v26, "licPermParser":Landroid/content/pm/LicPermissionParser;
    move-object/from16 v0, v26
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/content/pm/LicPermissionParser;->parse(Landroid/content/res/AssetManager;Landroid/content/pm/PackageParser$Package;Ljava/lang/String;)V
    :try_end_3
    ...
    .line 911
    .end local v26    # "licPermParser":Landroid/content/pm/LicPermissionParser;
    .end local v27    # "outError":[Ljava/lang/String;
    .end local v29    # "pkg":Landroid/content/pm/PackageParser$Package;
    .end local v31    # "res":Landroid/content/res/Resources;
    .restart local v30    # "res":Landroid/content/res/Resources;
...
.method private parseSplitApk(Landroid/content/pm/PackageParser$Package;ILandroid/content/res/AssetManager;I)V
    ...
    iget-object v4, v0, Landroid/content/pm/PackageParser$Package;->splitCodePaths:[Ljava/lang/String;

    aget-object v23, v4, p2
    ...
    .line 924
    .local v22, "apkFile":Ljava/io/File;
    const/4 v4, 0x1
    ...
    :try_start_0
    new-instance v29, Landroid/content/res/Resources;

    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/content/pm/PackageParser;->mMetrics:Landroid/util/DisplayMetrics;
    ...
    invoke-direct {v0, v1, v4, v5}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    :try_end_0
    ...
    .line 940
    invoke-direct/range {v4 .. v10}, Landroid/content/pm/PackageParser;->parseSplitApk(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;II[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    iget v5, v0, Landroid/content/pm/PackageParser;->mParseError:I
    ...
    .line 948
    .end local v28    # "res":Landroid/content/res/Resources;
    .restart local v10    # "outError":[Ljava/lang/String;
