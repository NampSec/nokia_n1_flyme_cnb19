...
.field private mUserAuthListener:Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
...
.method static synthetic access$200(Landroid/net/wifi/p2p/WifiP2pManager$Channel;)Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
    .locals 1
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;

    .prologue
    .line 714
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->mUserAuthListener:Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;

    return-object v0
.end method

.method static synthetic access$202(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;)Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
    .locals 0
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    .param p1, "x1"    # Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;

    .prologue
    .line 714
    iput-object p1, p0, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->mUserAuthListener:Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;

    return-object p1
.end method

.method static synthetic access$300(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/nsd/WifiP2pServiceResponse;)V
    .locals 0
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
...
.method static synthetic access$400(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pConfig;)V
    .locals 0
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    .prologue
    .line 714
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->handleUserAuthRequest(Landroid/net/wifi/p2p/WifiP2pConfig;)V

    return-void
.end method

.method static synthetic access$500(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/WpsInfo;)V
    .locals 0
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    .prologue
    .line 714
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->handleUserAuthShowPin(Landroid/net/wifi/WpsInfo;)V
...
.method private handleUserAuthRequest(Landroid/net/wifi/p2p/WifiP2pConfig;)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, v3}, Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;->onUserAuthorizationRequest(ILjava/lang/String;Ljava/lang/String;)V
...
.method private handleUserAuthShowPin(Landroid/net/wifi/WpsInfo;)V
    .locals 3
    .param p1, "wps"    # Landroid/net/wifi/WpsInfo;
    ...
    iget-object v1, p1, Landroid/net/wifi/WpsInfo;->pin:Ljava/lang/String;

    iget-object v2, p1, Landroid/net/wifi/WpsInfo;->BSSID:Ljava/lang/String;

    invoke-interface {v0, v1, v2}, Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;->onShowPin(Ljava/lang/String;Ljava/lang/String;)V
