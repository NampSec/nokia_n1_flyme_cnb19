...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;,
...
.field public static final EXTRA_RECONNECT_WIFI_DISPLAY:Ljava/lang/String; = "wifiP2pReconnect"
...
.field public static final PEER_CONNECTION_USER_ACCEPT:I = 0x22057

.field public static final PEER_CONNECTION_USER_REJECT:I = 0x22058
...
.field public static final SET_USER_AUTH:I = 0x22052

.field public static final SET_USER_AUTH_FAILED:I = 0x22053

.field public static final SET_USER_AUTH_SUCCEEDED:I = 0x22054
...
.field public static final USER_AUTH_REQUEST:I = 0x22055

.field public static final USER_AUTH_SHOW_PIN:I = 0x22056
...
.method public authorizeConnection(Landroid/net/wifi/p2p/WifiP2pManager$Channel;ZLjava/lang/String;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
    .locals 4
    .param p1, "c"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    .param p2, "accept"    # Z
    ...
    .line 1554
    # getter for: Landroid/net/wifi/p2p/WifiP2pManager$Channel;->mUserAuthListener:Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
    invoke-static {p1}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->access$200(Landroid/net/wifi/p2p/WifiP2pManager$Channel;)Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
    ...
    # invokes: Landroid/net/wifi/p2p/WifiP2pManager$Channel;->putListener(Ljava/lang/Object;)I
    invoke-static {p1, p4}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->access$800(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Ljava/lang/Object;)I

    move-result v2

    invoke-virtual {v0, v1, v3, v2, p3}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
...
.method public setUserAuthorizationListener(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
    .locals 4
    .param p1, "c"    # Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    .param p2, "authListener"    # Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
    .param p3, "listener"    # Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;
    ...
    invoke-static {p1, p2}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->access$202(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;)Landroid/net/wifi/p2p/WifiP2pManager$UserAuthorizationListener;
