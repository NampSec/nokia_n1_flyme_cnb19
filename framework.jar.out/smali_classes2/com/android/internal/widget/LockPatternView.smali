...
.field protected mRegularColor:I

.field private mSquareHeight:F

.field private mSquareWidth:F

.field protected mSuccessColor:I
...
.method private drawCircle(Landroid/graphics/Canvas;FFFZF)V
    ...
    invoke-virtual {p0, p5}, Lcom/android/internal/widget/LockPatternView;->getCurrentColor(Z)I
...
.method protected drawCircle(Landroid/graphics/Canvas;Lcom/android/internal/widget/LockPatternView$CellState;FFZ)V
    ...
    .param p3, "centerX"    # F
    .param p4, "centerY"    # F
    .param p5, "drawLookup"    # Z

    .prologue
    .line 886
    iget v0, p2, Lcom/android/internal/widget/LockPatternView$CellState;->size:F

    iget v1, p2, Lcom/android/internal/widget/LockPatternView$CellState;->scale:F

    mul-float v4, v0, v1

    .line 887
    .local v4, "size":F
    iget v7, p2, Lcom/android/internal/widget/LockPatternView$CellState;->translateY:F
    ...
    iget v6, p2, Lcom/android/internal/widget/LockPatternView$CellState;->alpha:F
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 911
    .local v11, "cell":Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    .line 916
    .end local v11    # "cell":Lcom/android/internal/widget/LockPatternView$Cell;
    :cond_0
    if-lez v26, :cond_3
    ...
    check-cast v25, Lcom/android/internal/widget/LockPatternView$Cell;

    .line 929
    .local v25, "nextCell":Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    .end local v18    # "dx":F
    .end local v19    # "dy":F
    .end local v25    # "nextCell":Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/internal/widget/LockPatternView;->drawCircle(Landroid/graphics/Canvas;Lcom/android/internal/widget/LockPatternView$CellState;FFZ)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/internal/widget/LockPatternView;->getCurrentColor(Z)I
    ...
    .line 969
    .restart local v11    # "cell":Lcom/android/internal/widget/LockPatternView$Cell;
    iget v4, v11, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    aget-object v4, v16, v4

    iget v5, v11, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    .restart local v23    # "lastY":F
    :cond_a
    const/4 v10, 0x1

    .line 974
    iget v4, v11, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    iget v5, v11, Lcom/android/internal/widget/LockPatternView$Cell;->row:I
    ...
    .line 978
    .local v31, "state":Lcom/android/internal/widget/LockPatternView$CellState;
    invoke-virtual {v15}, Landroid/graphics/Path;->rewind()V
    ...
    .line 987
    .end local v31    # "state":Lcom/android/internal/widget/LockPatternView$CellState;
    :cond_b
    move/from16 v22, v12
    ...
    .line 983
    .restart local v31    # "state":Lcom/android/internal/widget/LockPatternView$CellState;
    :cond_c
    invoke-virtual {v15, v12, v8}, Landroid/graphics/Path;->lineTo(FF)V
