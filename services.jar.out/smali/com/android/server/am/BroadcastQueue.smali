...
.method private sendBroadcastIntentEvent(Lcom/android/server/am/BroadcastRecord;)V
    .locals 14
    .param p1, "broadcastRecord"    # Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-virtual {v10}, Lcom/android/server/am/ActivityManagerService;->getUserManagerLocked()Lcom/android/server/pm/UserManagerService;
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/pm/UserManagerService;->getUserInfo(I)Landroid/content/pm/UserInfo;

    move-result-object v9

    .line 345
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v11, p1, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    .line 365
    .local v6, "receiversPackageNameList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 353
    .end local v6    # "receiversPackageNameList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :catch_0
    move-exception v0
    ...
    const-string v12, "SecurityException while retrieving userInfo: "
    ...
    .line 368
    .restart local v6    # "receiversPackageNameList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_4
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->receivers:Ljava/util/List;
    ...
    instance-of v10, v5, Landroid/content/pm/ResolveInfo;
    ...
    .line 372
    .restart local v5    # "receiver":Ljava/lang/Object;
    :cond_6
    instance-of v10, v5, Lcom/android/server/am/BroadcastFilter;
    ...
    .end local v5    # "receiver":Ljava/lang/Object;
    iget-object v10, v5, Lcom/android/server/am/BroadcastFilter;->packageName:Ljava/lang/String;
    ...
    .line 377
    :cond_7
    iget-object v10, p1, Lcom/android/server/am/BroadcastRecord;->callerPackage:Ljava/lang/String;

    iget-object v11, p1, Lcom/android/server/am/BroadcastRecord;->intent:Landroid/content/Intent;

    invoke-static {v10, v6, v11, v9}, Lcom/intel/asf/AsfAosp;->sendBroadcastIntentEvent(Ljava/lang/String;Ljava/util/List;Landroid/content/Intent;Landroid/content/pm/UserInfo;)Ljava/util/List;

    move-result-object v7

    .line 380
    .local v7, "removeIntentRecipients":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    if-eqz v7, :cond_2
    ...
    .line 383
    .local v8, "removeRecipient":Ljava/lang/String;
...
.method final processNextBroadcast(Z)V
    ...
    invoke-interface {v4, v6, v7}, Landroid/content/pm/IPackageManager;->isBroadcastAvailable(Ljava/lang/String;I)Z
    :try_end_c
    ...
    iget v7, v15, Landroid/content/pm/ApplicationInfo;->uid:I

    iget-object v8, v15, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    invoke-interface {v4, v6, v7, v8}, Lcom/android/internal/app/IAppOpsService;->checkOperation(IILjava/lang/String;)I

    move-result v18

    .line 1016
    .local v18, "appOpsMode":I
    if-eqz v18, :cond_21
    ...
    const-string v7, "disallow to deliver "
    ...
    .restart local v16    # "allowStart":Z
    :catch_7
    move-exception v20
    ...
    const-string v6, "exception occurs while checking AppOps OP_AUTO_START"
...
.method public scheduleBroadcastsLocked()V
    ...
    .prologue
    .line 399
    iget-boolean v3, p0, Lcom/android/server/am/BroadcastQueue;->mBroadcastsScheduled:Z
    ...
    .line 406
    .local v2, "parallelBroadcast":Lcom/android/server/am/BroadcastRecord;
    invoke-direct {p0, v2}, Lcom/android/server/am/BroadcastQueue;->sendBroadcastIntentEvent(Lcom/android/server/am/BroadcastRecord;)V

    goto :goto_1

    .line 408
    .end local v2    # "parallelBroadcast":Lcom/android/server/am/BroadcastRecord;
    :cond_1
    ...
    .line 409
    .local v1, "orderedBroadcast":Lcom/android/server/am/BroadcastRecord;
    invoke-direct {p0, v1}, Lcom/android/server/am/BroadcastQueue;->sendBroadcastIntentEvent(Lcom/android/server/am/BroadcastRecord;)V

    goto :goto_2

    .line 412
    .end local v1    # "orderedBroadcast":Lcom/android/server/am/BroadcastRecord;
    :cond_2
    ...
    invoke-virtual {v4, v5, p0}, Lcom/android/server/am/BroadcastQueue$BroadcastHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/android/server/am/BroadcastQueue$BroadcastHandler;->sendMessage(Landroid/os/Message;)Z
