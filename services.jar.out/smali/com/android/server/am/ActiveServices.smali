...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/am/ActivityManagerService;->getAppOpsService()Lcom/android/internal/app/IAppOpsService;

    move-result-object v6

    .line 2108
    .local v6, "appOps":Lcom/android/internal/app/IAppOpsService;
    const/16 v23, 0x30
    ...
    invoke-interface {v6, v0, v1, v2}, Lcom/android/internal/app/IAppOpsService;->checkOperation(IILjava/lang/String;)I

    move-result v7

    .line 2109
    .local v7, "appOpsMode":I
    if-eqz v7, :cond_0
    ...
    const-string v25, "disallow to restart service, pkg="
    ...
    .line 2148
    .local v22, "sr":Lcom/android/server/am/ServiceRecord;
    move-object/from16 v0, v22
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;->getBatteryStats()Lcom/android/internal/os/BatteryStatsImpl;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;->stopLaunchedLocked()V
    ...
    .line 2157
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ServiceRecord;->forceClearTracker()V
    ...
    .line 2163
    .local v18, "numClients":I
    add-int/lit8 v10, v18, -0x1

    .local v10, "bindingi":I
    :goto_2
    if-ltz v10, :cond_8
    ...
    iput-object v0, v9, Lcom/android/server/am/IntentBindRecord;->binder:Landroid/os/IBinder;
    ...
    .line 2173
    iget-object v0, v9, Lcom/android/server/am/IntentBindRecord;->apps:Landroid/util/ArrayMap;
    ...
    .end local v10    # "bindingi":I
    .end local v17    # "i":I
    .end local v18    # "numClients":I
    .end local v19    # "proc":Lcom/android/server/am/ProcessRecord;
    .end local v22    # "sr":Lcom/android/server/am/ServiceRecord;
    :catch_0
    move-exception v15
    ...
    const-string v24, "exception occurs while checking AppOps OP_AUTO_START"
    ...
    .restart local v22    # "sr":Lcom/android/server/am/ServiceRecord;
    :catchall_0
    move-exception v23
    ...
    .line 2182
    .restart local v8    # "appi":I
    .restart local v9    # "b":Lcom/android/server/am/IntentBindRecord;
    .restart local v10    # "bindingi":I
    .restart local v18    # "numClients":I
    ...
    .line 2209
    .local v20, "r":Lcom/android/server/am/ConnectionRecord;
    const/16 v23, 0x0
    ...
    .line 2211
    .end local v20    # "r":Lcom/android/server/am/ConnectionRecord;
    :cond_a
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/util/ArraySet;->clear()V
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v23 .. v27}, Lcom/android/internal/app/ProcessStats$ServiceState;->setStarted(ZIJ)V
