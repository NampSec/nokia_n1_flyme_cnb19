...
.field private static mIsPowered:Z
...
.field private mScreenCabcModeSetting:I
...
.method static synthetic access$5600(Lcom/android/server/power/PowerManagerService;J)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
...
.method private canDreamLocked()Z
    ...
    .line 1821
    sget-boolean v1, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    sget-boolean v9, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
...
.method public static isPowerPlugged()Z
    .locals 1

    .prologue
    .line 2448
    sget-boolean v0, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
...
.method private setLowPowerModeInternal(Z)Z
    ...
    .line 2195
    :try_start_0
    sget-boolean v3, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
...
.method private updateIsPoweredLocked(I)V
    ...
    sput-boolean v1, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
    ...
    sget-boolean v5, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
...
.method private updateScreenCabcport(Ljava/lang/String;)V
    .locals 3
    .param p1, "writeToCabc"    # Ljava/lang/String;
    ...
    const-string v2, "/sys/class/drm/card0/display/cabc_mode"

    invoke-direct {v1, v2}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 711
    .local v1, "screenCabcFile":Ljava/io/File;
    new-instance v0, Ljava/io/FileWriter;

    invoke-direct {v0, v1}, Ljava/io/FileWriter;-><init>(Ljava/io/File;)V

    .line 712
    .local v0, "fr":Ljava/io/FileWriter;
...
.method private updateSettingsLocked()V
    ...
    const-string v7, "moving_image"

    .line 632
    .local v7, "screenCabcModeOn":Ljava/lang/String;
    const-string v6, "off"

    .line 634
    .local v6, "screenCabcModeOff":Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v5, v11, v8, v12}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v5, v8, v11, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v5, v8, v13, v12}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v5, v8, v11, v12}, Landroid/provider/Settings$System;->getFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)F
    ...
    invoke-static {v5, v8, v10, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 677
    const-string v8, "screen_cabc_mode"

    invoke-static {v5, v8, v10, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v8

    iput v8, p0, Lcom/android/server/power/PowerManagerService;->mScreenCabcModeSetting:I

    .line 681
    iget v8, p0, Lcom/android/server/power/PowerManagerService;->mScreenCabcModeSetting:I

    if-ne v8, v9, :cond_b

    .line 683
    :try_start_0
    const-string v8, "moving_image"

    invoke-direct {p0, v8}, Lcom/android/server/power/PowerManagerService;->updateScreenCabcport(Ljava/lang/String;)V
    :try_end_0
...
.method public systemReady(Lcom/android/internal/app/IAppOpsService;)V
    ...
    .line 567
    const-string v0, "screen_cabc_mode"
...
.method updateLowPowerModeLocked()V
    ...
    sget-boolean v4, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
