...
.method static synthetic access$1200(Lcom/android/server/BluetoothManagerService;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
    ...
    .prologue
    .line 67
    invoke-direct {p0, p1, p2}, Lcom/android/server/BluetoothManagerService;->handleCoexSafeChannels(II)V

    return-void
.end method

.method static synthetic access$1300(Lcom/android/server/BluetoothManagerService;IIIIII)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
    ...
    .prologue
    .line 67
    invoke-direct/range {p0 .. p6}, Lcom/android/server/BluetoothManagerService;->handleCoexRtControl(IIIIII)V

    return-void
.end method

.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;IIIB[I[B)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
    ...
    .prologue
    .line 67
    invoke-direct/range {p0 .. p6}, Lcom/android/server/BluetoothManagerService;->handleCoexExternalFrameConfig(IIIB[I[B)V

    return-void
.end method

.method static synthetic access$1500(Lcom/android/server/BluetoothManagerService;[I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # [I
    ...
    .prologue
    .line 67
    invoke-direct {p0, p1}, Lcom/android/server/BluetoothManagerService;->handleSetMwsSignaling([I)V
...
.method static synthetic access$2900(Lcom/android/server/BluetoothManagerService;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$4300(Lcom/android/server/BluetoothManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method private handleCoexExternalFrameConfig(IIIB[I[B)V
    .locals 2
    .param p1, "frameDuration"    # I
    .param p2, "frameSyncOffset"    # I
    .param p3, "frameSyncJitter"    # I
    .param p4, "numPeriod"    # B
    .param p5, "periodDuration"    # [I
    .param p6, "periodType"    # [B

    .prologue
    .line 429
    const-string v0, "BluetoothManagerService"

    const-string v1, "handleCoexExternalFrameConfig"
...
.method private handleCoexRtControl(IIIIII)V
    .locals 6
    .param p1, "coexRtState"    # I
    .param p2, "rxCenterFreq"    # I
    .param p3, "txCenterFreq"    # I
    .param p4, "rxChannelBandwith"    # I
    .param p5, "txChannelBandwith"    # I
    ...
    .line 413
    iget-object v3, p0, Lcom/android/server/BluetoothManagerService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    const-string v5, "handleCoexRtControl : RT state = "
...
.method private handleCoexSafeChannels(II)V
    .locals 13
    .param p1, "minFreq"    # I
    .param p2, "maxFreq"    # I
    ...
    .line 340
    .local v2, "BT_LO_FREQ":I
    const/16 v1, 0x9b0

    .line 341
    .local v1, "BT_HI_FREQ":I
    const/16 v0, 0x4f

    .line 342
    .local v0, "AFH_CLASSIFICATION_SIZE":I
    const/16 v6, 0x25

    .line 345
    .local v6, "LE_CLASSIFICATION_SIZE":I
    const/16 v10, 0x9b0
    ...
    const-string v11, "COEX_SAFECHANNELS : Invalid frequency. Reset to default safe channels"
    ...
    const-string v12, "COEX_SAFECHANNELS : Building BR/EDR Channel Range for ["
    ...
    .line 365
    .local v3, "BtChannels":Ljava/util/BitSet;
    const/4 v10, 0x0

    const/16 v11, 0x4f

    invoke-virtual {v3, v10, v11}, Ljava/util/BitSet;->set(II)V

    .line 369
    add-int/lit16 v4, p1, -0x962

    .line 370
    .local v4, "BtLowerChannel":I
    add-int/lit16 v5, p2, -0x962

    .line 373
    .local v5, "BtUpperChannel":I
    if-lez v4, :cond_1

    .line 374
    const/4 v10, 0x0

    invoke-virtual {v3, v10, v4}, Ljava/util/BitSet;->clear(II)V
    ...
    invoke-virtual {v3, v10, v11}, Ljava/util/BitSet;->clear(II)V
    ...
    const-string v12, "COEX_SAFECHANNELS : BR/EDR Channel Range : ["
    ...
    .line 390
    .local v7, "LeChannels":Ljava/util/BitSet;
    const/4 v10, 0x0

    const/16 v11, 0x25

    invoke-virtual {v7, v10, v11}, Ljava/util/BitSet;->set(II)V

    .line 394
    add-int/lit16 v10, p1, -0x962
    ...
    .line 395
    .local v8, "LeLowerChannel":I
    add-int/lit16 v10, p2, -0x962
    ...
    .line 396
    .local v9, "LeUpperChannel":I
    if-lez v8, :cond_3

    .line 397
    const/4 v10, 0x0

    invoke-virtual {v7, v10, v8}, Ljava/util/BitSet;->clear(II)V
    ...
    invoke-virtual {v7, v10, v11}, Ljava/util/BitSet;->clear(II)V
    ...
    const-string v12, "COEX_SAFECHANNELS : LE Channel Range : ["
    ...
    .line 406
    iget-object v10, p0, Lcom/android/server/BluetoothManagerService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    iput-object v10, p0, Lcom/android/server/BluetoothManagerService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    .line 350
    .end local v3    # "BtChannels":Ljava/util/BitSet;
    .end local v4    # "BtLowerChannel":I
    .end local v5    # "BtUpperChannel":I
    .end local v7    # "LeChannels":Ljava/util/BitSet;
    .end local v8    # "LeLowerChannel":I
    .end local v9    # "LeUpperChannel":I
    :cond_6
    const/16 v10, 0x962
...
.method private handleSetMwsSignaling([I)V
    .locals 2
    .param p1, "params"    # [I
    ...
    const-string v1, "handleSetMwsSignaling"
...
.method private unbindAllBluetoothProfileServices()V
    ...
    invoke-static {v3}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$1800(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)V
...
.method public unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    invoke-static {v0, p2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$1700(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;Landroid/bluetooth/IBluetoothProfileServiceConnection;)V
